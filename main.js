...
function preload(){
    Peter_pan_song = loadSound("ok.mp3");
...
function draw(){
    ...
    if(scoreleftWrist > 0.2){
        ...
        if(song_Peter_pan == false){
            ...
            console.log("Song Name: Impearl march");
            document.getElementById("song_id").innerHTML = "Song Name: Impearl march";
        }
    }
    ...
    if(scorerightWrist > 0.2){
        ...
        if(song_Harry_potter_theme == false){
            ...
            console.log("Song Name: that song");
            document.getElementById("song_id").innerHTML = "Song Name: that song";
        }
    }
}
